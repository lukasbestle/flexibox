/* Flexibox 0.9 (09.03.2014) | https://github.com/vis7mac/flexibox | (c) Lukas Bestle */
var Flexibox=function(h,d){var e=this,f,c,l,g,m,n,k;this.options={stage:".lightboxstage",title:"span",image:"img",activeClass:"active",openCallback:null,closeCallback:null,scrolling:!0,debug:!1};if("object"===typeof d)for(f in d)d.hasOwnProperty(f)&&(this.options[f]=d[f]);c=document.querySelector(this.options.stage);l=c.querySelector(this.options.title);g=c.querySelector(this.options.image);h=Array.prototype.slice.call(h);window.flexibox={};this.active=window.flexibox.active=!1;this.data={image:null,
title:null};this.open=function(a,b){if(window.flexibox.active)return this.options.debug&&console.log("[Flexibox] Lightbox is already open!"),!1;if(this.options.openCallback&&!this.options.openCallback(a,b,c))return this.options.debug&&console.log('[Flexibox] Callback aborted opening the lightbox with image "'+a+'" and title "'+b+'".'),!1;this.active=window.flexibox.active=!0;this.data={image:a,title:b};g.src=a;g.alt=b;g.title=b;l.innerHTML=b;this.options.scrolling&&(document.body.style.overflow="hidden");
